...
var require_dist = __commonJS({
  "../interpreter/dist/index.js"(exports, module2) {
    init_cjs_shims();
      ...
      return __reExport2(
        __markAsModule2(
          __defProp2(
            ...
            "default",
            !isNodeMode && module22 && module22.__esModule
    ...
    var require_dist2 = __commonJS2({
      "../parser/dist/index.js"(exports2, module22) {
        init_cjs_shims2();
        ...
        var __markAsModule22 = (target) =>
          __defProp22(target, "__esModule", { value: true });
        var __export2 = (target, all) => {
          for (var name in all)
            __defProp22(target, name, { get: all[name], enumerable: true });
        };
        var __reExport22 = (target, module222, copyDefault, desc) => {
          if (
            (module222 && typeof module222 === "object") ||
            typeof module222 === "function"
          ) {
            for (let key of __getOwnPropNames22(module222))
              if (
                !__hasOwnProp22.call(target, key) &&
                (copyDefault || key !== "default")
              )
                __defProp22(target, key, {
                  get: () => module222[key],
                  enumerable:
                    !(desc = __getOwnPropDesc22(module222, key)) ||
                    desc.enumerable,
                });
          }
          return target;
        ...
        var __toCommonJS2 = /* @__PURE__ */ ((cache) => {
          return (module222, temp) => {
            return (
              (cache && cache.get(module222)) ||
              ((temp = __reExport22(__markAsModule22({}), module222, 1)),
              cache && cache.set(module222, temp),
              temp)
            );
          };
        })(typeof WeakMap !== "undefined" ? /* @__PURE__ */ new WeakMap() : 0);
        ...
        var TokenTypes = {
          ...
          JAB_TAK_YE_HAI: "jab tak ye hai", // jab tak bhai // while
          BAS_KARO_BAIGAN: "bas karo baigan", // bas kar bhai // break
          AGLA_DEKHO_BAIGAN: "agla dekho baigan", // agla dekh bhai // continue
          NALLA_TYPE: "NALLA", // null
          SEMI_COLON_TYPE: ";",
        ...
        var SPEC = [
          ...
          {
            regex: /^\bbiryani shuru\b/,
            tokenType: TokenTypes.BIRYANI_SHURU_TYPE,
          },
          {
          ...
          { regex: /^\bnai to patthe\b/, tokenType: TokenTypes.NAI_TO_PATTHE },
          {
            regex: /^\bsub hath diye to\b/,
            tokenType: TokenTypes.SUB_HATH_DIYE_TO,
          },
          { regex: /^\bnalla\b/, tokenType: TokenTypes.NALLA_TYPE },
          {
            regex: /^\bjab tak ye hai\b/,
            tokenType: TokenTypes.JAB_TAK_YE_HAI,
          },
          {
            regex: /^\bbas karo baigan\b/,
            tokenType: TokenTypes.BAS_KARO_BAIGAN,
          },
          {
            regex: /^\bagla dekho baigan\b/,
            tokenType: TokenTypes.AGLA_DEKHO_BAIGAN,
          },
          ...
          {
            regex: /^[*\/\%]/,
            tokenType: TokenTypes.MULTIPLICATIVE_OPERATOR_TYPE,
          },
        ...
        var Statement = class {
          ...
          static getStatementImpl(lookahead) {
            switch (lookahead.type) {
              case TokenTypes.BOLO_YAROO_TYPE:
              ...
              case TokenTypes.DEKHO_YAROO_YE_HAI_TYPE:
                return BhaiLangModule.getVariableStatement();
              case TokenTypes.AGAR_PATTHE:
                return BhaiLangModule.getIfStatement();
              case TokenTypes.JAB_TAK_YE_HAI:
                return BhaiLangModule.getWhileStatement();
              case TokenTypes.BAS_KARO_BAIGAN:
                return BhaiLangModule.getBreakStatement();
              case TokenTypes.AGLA_DEKHO_BAIGAN:
        ...
        var BlockStatement2 = class extends Statement {
          ...
          getStatement() {
            ...
            const body =
              ((_a = this._tokenExecutor.getLookahead()) == null
                ? void 0
                : _a.type) === TokenTypes.CLOSED_CURLY_BRACE_TYPE
                ? []
        ...
        var Expression = class {
          ...
          _getExpression(
            ...
            var _a;
            let left2 = Expression.getExpressionImpl(
              downstreamExpressionType
            ).getExpression();
            while (
              ((_a = this._tokenExecutor.getLookahead()) == null
                ? void 0
                : _a.type) === operatorToken
            ) {
              const operator =
                this._tokenExecutor.eatTokenAndForwardLookahead(operatorToken);
              const right2 = Expression.getExpressionImpl(
                downstreamExpressionType
              ).getExpression();
              left2 = {
                type: expressionType,
        ...
        var AdditiveExpression = class extends Expression {
          getExpression() {
            return this.getBinaryExpression(
              NodeType4.MultiplicativeExpression,
        ...
        var AssignmentExpression2 = class extends Expression {
          constructor() {
            super(...arguments);
            this._logicalORExpression = Expression.getExpressionImpl(
              NodeType4.LogicalORExpression
            );
          }
          getExpression() {
            var _a;
            const left2 = this._logicalORExpression.getExpression();
            if (
              !this._isAssignmentOperator(
                (_a = this._tokenExecutor.getLookahead()) == null
                  ? void 0
                  : _a.type
              )
            ...
            return {
              ...
              left: this._checkValidAssignmentTarget(left2),
          ...
          _checkValidAssignmentTarget(node) {
            if (node.type === NodeType4.IdentifierExpression) return node;
            throw new SyntaxError(
              "Invalid left hand side in assignment expression Baigan!! kuch to ghicchi kar diye"
            );
          }
        };
        var EqualityExpression = class extends Expression {
          getExpression() {
            return this.getBinaryExpression(
              NodeType4.RelationalExpression,
            ...
            switch (tokenType) {
              ...
              default:
                throw new UnsupportedTypeException(
                  `Baigan!! kuch to ghicchi kar diye token type not supproted for literal: ${tokenType}`
                );
            }
          }
        };
        ...
        var LogicalORExpression = class extends Expression {
          getExpression() {
            return this.getLogicalExpression(
              NodeType4.LogicalANDExpression,
        ...
        var ParanthesizedExpression = class extends Expression {
          getExpression() {
            ...
            const expression = Expression.getExpressionImpl(
              NodeType4.AssignmentExpression
            ).getExpression();
            this._tokenExecutor.eatTokenAndForwardLookahead(
            ...
            switch (token == null ? void 0 : token.type) {
              case TokenTypes.OPEN_PARENTHESIS_TYPE:
                return Expression.getExpressionImpl(
                  NodeType4.ParanthesizedExpression
                ).getExpression();
              case TokenTypes.STRING_TYPE:
              case TokenTypes.NUMBER_TYPE:
              case TokenTypes.BOOLEAN_TYPE:
        ...
        var HANDLED_LOOP_TOKEN_TYPES = [
          TokenTypes.SUB_HATH_DIYE_TO,
          TokenTypes.NAI_TO_PATTHE,
        ];
        var IfStatement2 = class extends Statement {
          ...
          getConditionalStatement(tokenType) {
            ...
            if (this._tokenExecutor.getLookahead() == null) {
              throw new SyntaxError(
                `Baigan!! kuch to ghicchi kar diye Unexpected end of "${tokenType}" statement`
              );
            }
          ...
          getStatement() {
            const ifStatement = this.getConditionalStatement(
              TokenTypes.AGAR_PATTHE
            );
            const alternates = [];
            for (
              let lookahead = this._tokenExecutor.getLookahead();
              lookahead !== null &&
              HANDLED_LOOP_TOKEN_TYPES.includes(lookahead.type);
              lookahead = this._tokenExecutor.getLookahead()
            ) {
              if (lookahead.type === TokenTypes.SUB_HATH_DIYE_TO) {
                alternates.push(
                  this._tokenExecutor.eatTokenAndForwardLookahead(
                    lookahead.type
                  ) &&
                ...
                break;
              } else if (lookahead.type === TokenTypes.NAI_TO_PATTHE) {
                alternates.push(
                  this.getConditionalStatement(TokenTypes.NAI_TO_PATTHE)
                );
              }
            }
            return __spreadProps2(__spreadValues2({}, ifStatement), {
              alternates,
            });
          }
        };
        var InitStatement2 = class extends Statement {
          ...
          getStatement() {
            var _a;
            this._tokenExecutor.eatTokenAndForwardLookahead(
              TokenTypes.BIRYANI_SHURU_TYPE
            );
            this._tokenExecutor.eatOptionalSemiColonToken();
            const body =
              ((_a = this._tokenExecutor.getLookahead()) == null
                ? void 0
                : _a.type) !== TokenTypes.BIRYANI_BARKHAST_TYPE
                ? this._statementList.getStatementList(
                    TokenTypes.BIRYANI_BARKHAST_TYPE
                  )
                : [];
            this._tokenExecutor.eatTokenAndForwardLookahead(
              TokenTypes.BIRYANI_BARKHAST_TYPE
        ...
        var VariableStatement2 = class extends Statement {
          ...
          getStatement() {
            this._tokenExecutor.eatTokenAndForwardLookahead(
              TokenTypes.DEKHO_YAROO_YE_HAI_TYPE
            );
          ...
          _getVariableDeclaration() {
            ...
            const init =
              ((_a = this._tokenExecutor.getLookahead()) == null
                ? void 0
                : _a.type) !== TokenTypes.SEMI_COLON_TYPE &&
              ((_b = this._tokenExecutor.getLookahead()) == null
                ? void 0
                : _b.type) !== TokenTypes.COMMA_TYPE
        ...
        var WhileStatement2 = class extends Statement {
          getStatement() {
            ...
            if (this._tokenExecutor.getLookahead() == null) {
              throw new SyntaxError(
                `Baigan!! kuch to ghicchi kar diye Unexpected end of "jab tak ye hai" statement`
              );
            }
        ...
        var StatementList = class {
          ...
          getInitialStatementList() {
            for (
              let lookahead = this._tokenExecutor.getLookahead();
              lookahead !== null &&
              lookahead.type !== TokenTypes.BIRYANI_SHURU_TYPE;
              lookahead = this._tokenExecutor.getLookahead()
            ) {
          ...
          getStatementList(stopLookaheadType) {
            ...
            for (
              ...
              statementlist.push(
                Statement.getStatementImpl(lookahead).getStatement()
              );
            }
        ...
        var TokenExecutor = class {
          ...
          eatTokenAndForwardLookahead(tokenType) {
            ...
            if (token == null) {
              throw new SyntaxError(
                `Baigan!! kuch to ghicchi kar diye Unexpected end of input, expected : "${tokenType}"`
              );
            }
            if (token.type !== tokenType) {
              throw new SyntaxError(
                `Baigan mai mila diye code!! ...Unexpected token: "${token.value}", expected : "${tokenType}"`
              );
            }
          ...
          eatOptionalSemiColonToken() {
            var _a;
            if (
              ((_a = this.getLookahead()) == null ? void 0 : _a.type) ==
              TokenTypes.SEMI_COLON_TYPE
            )
        ...
        var TokenizerImpl = class {
          ...
          getNextToken() {
            if (!this._string)
              throw new InvalidStateException2(
        ...
        var BhaiLangModule = class {
          ...
          static getInitStatement() {
            if (!this._initStatement)
              this._initStatement = new InitStatement2(
          ...
          static getPrintStatement() {
            if (!this._printStatement) {
              this._printStatement = new PrintStatement2(
                this.getTokenExecutor()
              );
            }
          ...
          static getBreakStatement() {
            if (!this._breakStatement) {
              this._breakStatement = new BreakStatement2(
                this.getTokenExecutor()
              );
            }
          ...
          static getContinueStatement() {
            if (!this._continueStatement) {
              this._continueStatement = new ContinueStatement2(
                this.getTokenExecutor()
              );
            }
          ...
          static getWhileStatement() {
            if (!this._whileStatement) {
              this._whileStatement = new WhileStatement2(
                this.getTokenExecutor()
              );
            }
          ...
          static getExpressionStatement() {
            if (!this._expresionStatement) {
              this._expresionStatement = new ExpressionStatement2(
                this.getTokenExecutor()
              );
            }
          ...
          static getEmptyStatement() {
            if (!this._emptyStatement) {
              this._emptyStatement = new EmptyStatement2(
                this.getTokenExecutor()
              );
            }
          ...
          static getBlockStatement() {
            if (!this._blockStatement) {
              this._blockStatement = new BlockStatement2(
                this.getTokenExecutor(),
                this.getStatementList()
              );
            }
          ...
          static getVariableStatement() {
            if (!this._variableStatement)
              this._variableStatement = new VariableStatement2(
                this.getTokenExecutor(),
                this.getNullLiteral()
              );
          ...
          static getPrimaryExpression() {
            if (!this._primaryExpression) {
              this._primaryExpression = new PrimaryExpression(
                this.getTokenExecutor()
              );
            }
          ...
          static getIndentifierExpression() {
            if (!this._idetifierExpression)
              this._idetifierExpression = new IdentifierExpression2(
                this.getTokenExecutor()
              );
          ...
          static getAssignmentExpression() {
            if (!this._assignmentExpression)
              this._assignmentExpression = new AssignmentExpression2(
                this.getTokenExecutor()
              );
          ...
          static getNumericLiteral() {
            if (!this._numericLiteral) {
              this._numericLiteral = new NumericLiteral2(
                this.getTokenExecutor()
              );
            }
          ...
          static getBooleanLiteral() {
            if (!this._booleanLiteral) {
              this._booleanLiteral = new BooleanLiteral2(
                this.getTokenExecutor()
              );
            }
        ...
        module22.exports = __toCommonJS2(src_exports2);
      },
    });
    var src_exports = {};
    ...
    init_cjs_shims2();
    init_cjs_shims2();
    var import_bhai_lang_parser3 = __toESM2(require_dist2());
    init_cjs_shims2();
    init_cjs_shims2();
    init_cjs_shims2();
    ...
    var Scope = class {
      ...
      get(identifier) {
        ...
        throw new RuntimeException(
          `Baigan bhi Variable "${identifier}" banaye nai ho tum.`
        );
      }
      assign(identifier, value) {
        ...
        throw new RuntimeException(
          `Baigan bhi Variable "${identifier}" banaye nai ho tum to assign kaise kar rahe ho ??`
        );
      }
    ...
    function checkNumberAndStringOperands(operands) {
      return (
        (typeof operands.left === "string" &&
          typeof operands.right === "number") ||
        (typeof operands.right === "string" &&
          typeof operands.left === "number")
      );
    }
    ...
    var AssignmentExpression = class {
      visitNode(node) {
        ...
        if (identifier && node.operator) {
          const left2 = currentScope.get(identifier);
          if (left2 === null && node.operator !== "=")
            throw new NallaPointerException(
              `Nalla operand ni jamta "${node.operator}" ke sath`
            );
          if ((left2 === true || left2 === false) && node.operator !== "=")
            throw new RuntimeException(
    ...
    init_cjs_shims2();
    var import_bhai_lang_parser = __toESM2(require_dist2());
    var BinaryExpression = class {
      visitNode(node) {
        if (!node.left || !node.right || !node.operator) {
          throw new InvalidStateException(
            `Baigan!! kuch to ghicchi kar diye Left , right or operator not found for: ${node.type}`
          );
        }
        let left2, right2;
        if (node.type == import_bhai_lang_parser.NodeType.BinaryExpression) {
          ...
          left2 = this._getNodeValue(node.left);
          right2 = this._getNodeValue(node.right);
        } else if (
          node.type == import_bhai_lang_parser.NodeType.LogicalExpression
        ) {
          this._checkNalla(node);
          left2 =
            node.left.type == import_bhai_lang_parser.NodeType.BooleanLiteral
              ? node.left.value == "sahi"
                ? true
                : false
              : InterpreterModule.getVisitor(node.left.type).visitNode(
                  node.left
                );
          right2 =
            node.right.type == import_bhai_lang_parser.NodeType.BooleanLiteral
              ? node.right.value == "sahi"
                ? true
                : false
              : InterpreterModule.getVisitor(node.right.type).visitNode(
                  node.right
                );
        }
        return getOperationValue({ left: left2, right: right2 }, node.operator);
      }
      _checkNalla(node) {
        if (!node.left || !node.right || !node.operator) {
          throw new InvalidStateException(
        ...
        if (
          node.left.type === import_bhai_lang_parser.NodeType.NullLiteral ||
          node.right.type === import_bhai_lang_parser.NodeType.NullLiteral
        )
          throw nallaException;
        if (
          node.left.type ===
            import_bhai_lang_parser.NodeType.IdentifierExpression &&
          node.left.name
        ) {
        ...
        if (
          ...
          const value = InterpreterModule.getCurrentScope().get(
            node.right.name
          );
          if (value === null) throw nallaException;
        }
      ...
      _checkBoolean(node) {
        ...
        const runtimeException = new RuntimeException(
          `Baigan mai mila diye code!! ....Boolean operand ni jamta "${node.operator}" ke sath`
        );
        if (
          node.left.type === import_bhai_lang_parser.NodeType.BooleanLiteral ||
          node.right.type === import_bhai_lang_parser.NodeType.BooleanLiteral
      ...
      _getNodeValue(node) {
        ...
        if (
          node.type === import_bhai_lang_parser.NodeType.IdentifierExpression &&
          node.name
        )
    ...
    var BreakStatement = class {
      visitNode() {
        if (InterpreterModule.getCurrentScope().isLoop()) {
          ...
          throw new RuntimeException(
            `Kya "bas karo baigan"?? Loop kahan hai? Error: using break without loop`
          );
        }
      }
    };
    ...
    var ContinueStatement = class {
      visitNode() {
        if (InterpreterModule.getCurrentScope().isLoop()) {
          ...
          throw new RuntimeException(
            `Kha "agla dekho baigan"?? Loop kidhar hai? Error: using continue without loop`
          );
        }
      }
    };
    ...
    var IdentifierExpression = class {
      visitNode(node) {
        if (!node.name) {
          throw new InvalidStateException(
            `Invalid node name for: ${node.type}`
          );
        }
            ...
            if (alternates && alternates.length > 0) {
              for (var alternate of alternates) {
                ...
                if (!alternateTest) {
                  ...
                  const testResult2 = InterpreterModule.getVisitor(
                    alternateTest.type
    ...
    var PrintStatement = class {
      visitNode(node) {
        if (!node.expressions)
          throw new InvalidStateException(
            `No expressions to print: ${node.expressions} Baigan print kya karna ??`
          );
        const value = node.expressions
          .map((expression) => {
            ...
            if (currentNodeOutput === true) currentNodeOutput = "sahi";
            else if (currentNodeOutput === false) currentNodeOutput = "galat";
    ...
    var Program = class {
      visitNode(node) {
        if (Array.isArray(node.body) || !node.body)
          throw new InvalidStateException(
            `Invalid node body for : ${node.type}`
          );
    ...
    init_cjs_shims2();
    var import_bhai_lang_parser2 = __toESM2(require_dist2());
    var VariableDeclaration = class {
      visitNode(node) {
        if (!node.id || !node.init) {
          throw new InvalidStateException(
            `id or init not found for ${node.type}`
          );
        }
        ...
        if (node.init.type === import_bhai_lang_parser2.NodeType.NullLiteral)
          ...
          node.init.type === import_bhai_lang_parser2.NodeType.BooleanLiteral
        )
    ...
    var VariableStatement = class {
      visitNode(node) {
        if (!node.declarations)
          throw new InvalidStateException(
            `variable declarations in variable statement is not present: ${node.declarations} sahi se variable declare karo`
          );
      ...
      visitNode(node) {
        ...
        if (test) {
          ...
          for (
            ...
            testResult === true || testResult === "sahi";
            ...
            if (executions > 5e3) {
              throw new RuntimeException(
                "Bohot jyada hi chale jaa rha hai loop, thak gaya hai wo!!"
              );
            }
            if (InterpreterModule.getCurrentScope().isContinueStatement()) {
    ...
    var _InterpreterModule = class {
      ...
      static getInterpreter() {
        var _a;
        this._interpreter =
          (_a = this._interpreter) != null
            ? _a
            : new Interpreter(
                import_bhai_lang_parser3.default,
      ...
      static getCurrentScope() {
        var _a;
        this._currentScope =
          (_a = this._currentScope) != null ? _a : new Scope(null);
    ...
    InterpreterModule._visitorMap = {
      ...
      [import_bhai_lang_parser3.NodeType.VariableStatement]:
        new VariableStatement(),
      [import_bhai_lang_parser3.NodeType.IdentifierExpression]:
        new IdentifierExpression(),
      [import_bhai_lang_parser3.NodeType.VariableDeclaration]:
        new VariableDeclaration(),
      [import_bhai_lang_parser3.NodeType.AssignmentExpression]:
        new AssignmentExpression(),
      [import_bhai_lang_parser3.NodeType.ExpressionStatement]:
        new ExpressionStatement(),
      [import_bhai_lang_parser3.NodeType.BinaryExpression]:
        new BinaryExpression(),
      [import_bhai_lang_parser3.NodeType.LogicalExpression]:
        new BinaryExpression(),
      ...
      [import_bhai_lang_parser3.NodeType.ContinueStatement]:
...
// src/index.ts
init_cjs_shims();
var import_bhai_lang_interpreter = __toESM(require_dist());
...
function assembleStyles() {
  ...
  Object.defineProperties(styles2, {
    ...
    rgbToAnsi: {
      value: (red, green, blue) =>
        styles2.ansi256ToAnsi(styles2.rgbToAnsi256(red, green, blue)),
      enumerable: false,
    },
    hexToAnsi: {
...
var UI = class {
  ...
  rasterize(row) {
    ...
    row.forEach((col, c) => {
      ...
      if (this.wrap) {
        wrapped = mixin
          .wrap(col.text, this.negatePadding(col), { hard: true })
          .split("\n");
      } else {
...
function sync_default(start, callback) {
  ...
  let tmp,
    stats = (0, import_fs.statSync)(dir);
      ...
      if (
        ...
        keys.forEach(function (key2) {
          Object.defineProperty(argvReturn, key2, {
            ...
            set(value2) {
              val =
                typeof value2 === "string" ? mixin2.normalize(value2) : value2;
            },
          });
        });
      }
...
var REQUIRE_DIRECTORY_ERROR =
  "loading a directory of commands is not supported yet for ESM";
var __dirname;
try {
  __dirname = (0, import_url.fileURLToPath)(importMetaUrl);
} catch (e) {
...
var CommandInstance = class {
  ...
  runCommand(
    ...
    const commandHandler =
      this.handlers[command2] ||
      this.handlers[this.aliasMap[command2]] ||
      this.defaultCommand;
...
function usage(yargs, shim3) {
  ...
  let commands = [];
  self.command = function command2(
    cmd,
    description,
    isDefault,
    aliases,
...
`;
    ...
    if (commands.length > 1 || (commands.length === 1 && !commands[0][2])) {
      ...
      commands.forEach((command2) => {
        const commandString = `${prefix}${parentCommands}${command2[0].replace(
          /^\$0 ?/,
          ""
        )}`;
        ui2.span(
...
`);
  ...
  self.functionDescription = (fn) => {
    const description = fn.name
      ? shim3.Parser.decamelize(fn.name, "-")
      : __("generated-value");
...
var Completion = class {
  constructor(yargs, usage2, command2, shim3) {
    ...
    this.zshShell =
      (_c =
        ((_a = this.shim.getEnv("SHELL")) === null || _a === void 0
          ? void 0
          : _a.includes("zsh")) ||
  ...
  argsContainKey(args, argv, key, negable) {
    ...
    if (this.aliases) {
      for (const alias of this.aliases[key]) {
        if (argv[alias] !== void 0) return true;
      }
    }
    return false;
  }
...
${customMsgs.join("\n")}`
  ...
  self.unknownArguments = function unknownArguments(
    ...
    if (checkPositionals) {
      ...
      const maxNonOptDemanded =
        ((_a = demandedCommands._) === null || _a === void 0
          ? void 0
          : _a.max) || 0;
  ...
  ${__(
    ...
    key,
    usage2.stringifiedValues(invalid[key]),
    usage2.stringifiedValues(options.choices[key])
  )}`;
    });
    usage2.fail(msg);
  };
...
`;
  ...
  self.recommendCommands = function recommendCommands(cmd, potentialCommands) {
    ...
    for (
      let i = 0, candidate;
      (candidate = potentialCommands[i]) !== void 0;
      i++
    ) {
...
var kPopulateParserHintSingleValueDictionary = Symbol(
  "populateParserHintSingleValueDictionary"
);
var kPopulateParserHintArrayDictionary = Symbol(
...
var kRunYargsParserAndExecuteCommands = Symbol(
  "runYargsParserAndExecuteCommands"
);
...
var YargsInstance = class {
  ...
  coerce(keys, value) {
    ...
    __classPrivateFieldGet(
      ...
      _YargsInstance_globalMiddleware,
      "f"
    ).addCoerceMiddleware((argv, yargs) => {
      let aliases;
      return maybeAsyncResult(
        () => {
  ...
  conflicts(key1, key2) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_validation, "f").conflicts(
      key1,
      key2
    );
    return this;
  ...
  config(key = "config", msg, parseFn) {
    ...
    (Array.isArray(key) ? key : [key]).forEach((k) => {
      __classPrivateFieldGet(this, _YargsInstance_options, "f").config[k] =
        parseFn || true;
    });
    return this;
  }
  ...
  default(key, value, defaultDescription) {
    ...
    if (defaultDescription) {
      ...
      __classPrivateFieldGet(
        ...
        _YargsInstance_options,
        "f"
      ).defaultDescription[key] = defaultDescription;
    }
    if (typeof value === "function") {
      assertSingleKey(
        key,
      ...
      if (
        ...
        __classPrivateFieldGet(
          ...
          _YargsInstance_options,
          "f"
        ).defaultDescription[key] = __classPrivateFieldGet(
          this,
          _YargsInstance_usage,
          "f"
  ...
  deprecateOption(option, message) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_options, "f").deprecatedOptions[
      option
    ] = message;
    return this;
  }
  describe(keys, description) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_usage, "f").describe(
      keys,
      description
    );
    return this;
  ...
  env(prefix) {
    ...
    if (prefix === false)
      delete __classPrivateFieldGet(this, _YargsInstance_options, "f")
        .envPrefix;
    else
      __classPrivateFieldGet(this, _YargsInstance_options, "f").envPrefix =
        prefix || "";
    return this;
  }
  epilogue(msg) {
  ...
  example(cmd, description) {
    ...
    if (Array.isArray(cmd)) {
      ...
      __classPrivateFieldGet(this, _YargsInstance_usage, "f").example(
        cmd,
        description
      );
    }
    ...
    if (!done) {
      return new Promise((resolve5, reject) => {
        __classPrivateFieldGet(
          ...
          _YargsInstance_completion,
          "f"
        ).getCompletion(args, (err, completions) => {
          if (err) reject(err);
  ...
  getHelp() {
    ...
    return Promise.resolve(
      __classPrivateFieldGet(this, _YargsInstance_usage, "f").help()
    );
  }
  getOptions() {
    return __classPrivateFieldGet(this, _YargsInstance_options, "f");
    ...
    if (global !== false) {
      ...
      globals.forEach((g) => {
        if (
          ...
          __classPrivateFieldGet(this, _YargsInstance_options, "f").local.push(
            g
          );
      });
    }
  ...
  group(opts, groupName) {
    ...
    if (
      ...
      delete __classPrivateFieldGet(this, _YargsInstance_preservedGroups, "f")[
        groupName
      ];
    }
    const seen = {};
  ...
  implies(key, value) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_validation, "f").implies(
      key,
      value
    );
    return this;
  ...
  locale(locale) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_shim, "f").y18n.setLocale(
      locale
    );
    return this;
  }
  ...
  option(key, opt) {
    ...
    if (typeof key === "object") {
      ...
      if (opt.demandOption) {
        this.demandOption(
          key,
          typeof opt.demandOption === "string" ? opt.demandOption : void 0
        );
      }
      if (opt.conflicts) {
      ...
      if (opt.defaultDescription) {
        __classPrivateFieldGet(
          ...
          _YargsInstance_options,
          "f"
        ).defaultDescription[key] = opt.defaultDescription;
      }
  ...
  parse(args, shortCircuit, _parseFn) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_completion, "f").setParsed(
      this.parsed
    );
    if (isPromise(parsed)) {
      return parsed
  ...
  positional(key, opts) {
    ...
    const fullCommand = __classPrivateFieldGet(
      this,
      _YargsInstance_context,
      "f"
    ).fullCommands[
      __classPrivateFieldGet(this, _YargsInstance_context, "f").fullCommands
        .length - 1
    ];
  ...
  showHelp(level) {
    ...
    if (
      ...
      if (!this.parsed) {
        ...
        if (isPromise(parse)) {
          parse.then(() => {
            __classPrivateFieldGet(this, _YargsInstance_usage, "f").showHelp(
              level
            );
          });
          return this;
  ...
  showHelpOnFail(enabled, message) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_usage, "f").showHelpOnFail(
      enabled,
      message
    );
    return this;
  ...
  terminalWidth() {
    argsert([], 0);
    return __classPrivateFieldGet(this, _YargsInstance_shim, "f").process
      .stdColumns;
  }
  updateLocale(obj) {
  ...
  updateStrings(obj) {
    ...
    __classPrivateFieldSet(this, _YargsInstance_detectLocale, false, "f");
    __classPrivateFieldGet(this, _YargsInstance_shim, "f").y18n.updateLocale(
      obj
    );
    return this;
  }
  ...
  version(opt, msg, ver) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_usage, "f").version(
      ver || void 0
    );
  ...
  [kDeleteFromParserHintObject](optionKey) {
    objectKeys(
      ...
      const hint = __classPrivateFieldGet(this, _YargsInstance_options, "f")[
        hintKey
      ];
    ...
    delete __classPrivateFieldGet(
      ...
      _YargsInstance_usage,
      "f"
    ).getDescriptions()[optionKey];
  }
  [kEmitWarning](warning, type, deduplicationId) {
    if (
      !__classPrivateFieldGet(this, _YargsInstance_emittedWarnings, "f")[
        deduplicationId
      ]
    ) {
      __classPrivateFieldGet(
  ...
  [kFreeze]() {
    __classPrivateFieldGet(this, _YargsInstance_frozens, "f").push({
      ...
      configObjects: __classPrivateFieldGet(
        this,
        _YargsInstance_options,
        "f"
      ).configObjects.slice(0),
      exitProcess: __classPrivateFieldGet(
        this,
      ...
      strictCommands: __classPrivateFieldGet(
        this,
        _YargsInstance_strictCommands,
        "f"
      ),
      strictOptions: __classPrivateFieldGet(
        this,
        _YargsInstance_strictOptions,
        "f"
      ),
      completionCommand: __classPrivateFieldGet(
        this,
        _YargsInstance_completionCommand,
        "f"
      ),
      ...
      parseContext: __classPrivateFieldGet(
        this,
        _YargsInstance_parseContext,
        "f"
      ),
  ...
  [kGetDollarZero]() {
    ...
    if (
      ...
      default$0 = __classPrivateFieldGet(this, _YargsInstance_shim, "f")
        .process.argv()
        .slice(1, 2);
    } else {
      default$0 = __classPrivateFieldGet(this, _YargsInstance_shim, "f")
  ...
  [kGuessLocale]() {
    ...
    const locale =
      ...
      __classPrivateFieldGet(this, _YargsInstance_shim, "f").getEnv(
        "LC_MESSAGES"
      ) ||
  ...
  [kPkgUp](rootPath) {
    ...
    try {
      ...
      if (
        ...
        startDir = __classPrivateFieldGet(
          this,
          _YargsInstance_shim,
          "f"
        ).path.dirname(startDir);
      }
      const pkgJsonPath = __classPrivateFieldGet(
        this,
        _YargsInstance_shim,
        "f"
      ).findUp(startDir, (dir, names) => {
      ...
      obj = JSON.parse(
        __classPrivateFieldGet(this, _YargsInstance_shim, "f").readFileSync(
          pkgJsonPath,
          "utf8"
        )
      );
  ...
  [kPopulateParserHintArrayDictionary](builder, type, key, value) {
    this[kPopulateParserHintDictionary](
      ...
      (type2, key2, value2) => {
        __classPrivateFieldGet(this, _YargsInstance_options, "f")[type2][key2] =
          (
            __classPrivateFieldGet(this, _YargsInstance_options, "f")[type2][
              key2
            ] || []
          ).concat(value2);
      }
  ...
  [kUnfreeze]() {
    ...
    const frozen = __classPrivateFieldGet(
      this,
  ...
  [kReset](aliases = {}) {
    ...
    Object.assign(
      ...
      Object.keys(
        ...
        const keys = __classPrivateFieldGet(this, _YargsInstance_groups, "f")[
          groupName
        ].filter((key) => !(key in localLookup));
        if (keys.length > 0) {
          acc[groupName] = keys;
        }
        return acc;
    ...
    tmpOptions.envPrefix = __classPrivateFieldGet(
      this,
      _YargsInstance_options,
      "f"
    ).envPrefix;
    ...
    __classPrivateFieldSet(
      ...
      _YargsInstance_usage,
      __classPrivateFieldGet(this, _YargsInstance_usage, "f")
        ? __classPrivateFieldGet(this, _YargsInstance_usage, "f").reset(
            localLookup
          )
    ...
    __classPrivateFieldSet(
      ...
      _YargsInstance_validation,
      __classPrivateFieldGet(this, _YargsInstance_validation, "f")
        ? __classPrivateFieldGet(this, _YargsInstance_validation, "f").reset(
            localLookup
          )
        : validation(
            this,
  ...
  [kRebase](base, dir) {
    return __classPrivateFieldGet(this, _YargsInstance_shim, "f").path.relative(
      base,
      dir
    );
  }
  [kRunYargsParserAndExecuteCommands](
    ...
    const populateDoubleDash = !!__classPrivateFieldGet(
      this,
      _YargsInstance_options,
      "f"
    ...
    const parsed = __classPrivateFieldGet(
      this,
      _YargsInstance_shim,
      "f"
    ).Parser.detailed(
    ...
    Object.keys(argv).forEach((key) => {
      if (
        key === __classPrivateFieldGet(this, _YargsInstance_helpOpt, "f") &&
        argv[key]
      ) {
        helpOptSet = true;
      } else if (
    ...
    try {
      ...
      const handlerKeys = __classPrivateFieldGet(
        this,
        _YargsInstance_command,
        "f"
      ).getCommands();
      const requestCompletions =
        __classPrivateFieldGet(this, _YargsInstance_completion, "f")
          .completionKey in argv;
        ...
        if (handlerKeys.length) {
          ...
          if (
            ...
            __classPrivateFieldGet(
              ...
              _YargsInstance_validation,
              "f"
            ).recommendCommands(firstUnknownCommand, handlerKeys);
          }
        }
        if (
          __classPrivateFieldGet(this, _YargsInstance_completionCommand, "f") &&
      ...
      if (requestCompletions) {
        ...
        __classPrivateFieldGet(
          ...
          _YargsInstance_completion,
          "f"
        ).getCompletion(completionArgs, (err, completions) => {
      ...
      if (!__classPrivateFieldGet(this, _YargsInstance_hasOutput, "f")) {
        if (helpOptSet) {
          ...
          if (__classPrivateFieldGet(this, _YargsInstance_exitProcess, "f"))
            setBlocking(true);
          skipValidation = true;
          __classPrivateFieldGet(this, _YargsInstance_usage, "f").showVersion(
            "log"
          );
          this.exit(0);
        }
      ...
      if (
        !skipValidation &&
        __classPrivateFieldGet(this, _YargsInstance_options, "f").skipValidation
          .length > 0
      ) {
        skipValidation = Object.keys(argv).some(
          (key) =>
            __classPrivateFieldGet(
              ...
              _YargsInstance_options,
              "f"
            ).skipValidation.indexOf(key) >= 0 && argv[key] === true
        );
      }
      if (!skipValidation) {
  ...
  [kRunValidation](aliases, positionalMap, parseErrors, isDefaultCommand) {
    ...
    return (argv) => {
      ...
      __classPrivateFieldGet(
        ...
        _YargsInstance_validation,
        "f"
      ).requiredArguments(argv, demandedOptions);
      ...
      if (
        __classPrivateFieldGet(this, _YargsInstance_strict, "f") &&
        ...
        __classPrivateFieldGet(
          ...
          _YargsInstance_validation,
          "f"
        ).unknownArguments(argv, aliases, positionalMap, !!isDefaultCommand);
      } else if (
        __classPrivateFieldGet(this, _YargsInstance_strictOptions, "f")
      ) {
        __classPrivateFieldGet(
          this,
          _YargsInstance_validation,
          "f"
        ).unknownArguments(argv, aliases, {}, false, false);
      }
      __classPrivateFieldGet(
        this,
        _YargsInstance_validation,
      ...
      __classPrivateFieldGet(this, _YargsInstance_validation, "f").implications(
        argv
      );
      __classPrivateFieldGet(this, _YargsInstance_validation, "f").conflicting(
        argv
      );
    };
  }
...
// src/index.ts
console.info(
  source_default.hex("#83aaff")(`Asli Biryani Hyderabadi Biryani hai !!
`)
);
var cl = console.log;
console.log = function (...args) {
  const newArgs = args.map((arg) => {
    return `${source_default.hex("#83aaff")(">  ")}${source_default.greenBright(
      arg
    )}`;
  });
  cl.apply(console, newArgs);
};
var filePath = yargs_default(hideBin(process.argv))
  .command(
    "<filepath>",
...
import_fs5.default.readFile(filePath, "utf8", (err, data) => {
  if (err) {
    console.error(err);
    return;
  }
  try {
    ...
    if (ex instanceof Error) {
      console.error("\n", source_default.redBright(ex.stack));
    }
  }
});
/**
